...
var processCSV = function (_a) {
    ...
    fs.createReadStream(csvPath)
        ...
        var text, name, topics, bestGuess, valueBestGuess, keywordsFounds;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    text = row.text;
                    name = row.name;
                    topics = Object.keys(topic_classifier_1.rabbitMQTopics);
                    bestGuess = null;
                    valueBestGuess = null;
                    keywordsFounds = [];
                    ...
                    if (!bestGuess) return [3, 2];
                    return [4, callbackMessage(bestGuess, valueBestGuess)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [2];
